...
public enum ScoreType implements IScorable{
    TERMINAL(FIND_TERMINAL, new ExponentialFallOf(MathUtils.convertKilometresToUnits(100), 500, 3)),
    ...
    BUS(FIND_BUS, new LinearFallOf(MathUtils.convertKilometresToUnits(3), 20)),
    TRAIN(FIND_TRAIN, new LinearFallOf(MathUtils.convertKilometresToUnits(10), 100)),
    TRAM(FIND_TRAM, new ConstantFallOf(MathUtils.convertKilometresToUnits(1.5), 30)),
    HOSPITAL(FIND_HOSPITAL, new ExponentialFallOf(MathUtils.convertKilometresToUnits(25), 120, 3)),
    ...
    VETERINARY(FIND_VETERINARY, new ExponentialFallOf(MathUtils.convertKilometresToUnits(20), 10, 3)),
    DOCTORS(FIND_DOCTORS, new LinearFallOf(MathUtils.convertKilometresToUnits(10), 70)),
    BLOOD_DONATION(FIND_BLOOD_DONATION, new LinearFallOf(MathUtils.convertKilometresToUnits(30), 100)),
    SCHOOL(FIND_SCHOOL, new ConstantFallOf(MathUtils.convertKilometresToUnits(6), 50)),
    COLLEGE(FIND_COLLEGE, new LinearFallOf(MathUtils.convertKilometresToUnits(20), 50)),
    LIBRARY(FIND_LIBRARY, new LinearFallOf(MathUtils.convertKilometresToUnits(15), 200)),
    MUSEUM(FIND_MUSEUM, new LinearFallOf(MathUtils.convertKilometresToUnits(30), 25)),
    RESEARCH_INSTITUTION(FIND_RESEARCH_INSTITUTION, new ExponentialFallOf(MathUtils.convertKilometresToUnits(100), 500, 3)),
    THEATRE(FIND_THEATRE, new LinearFallOf(MathUtils.convertKilometresToUnits(50), 25));
